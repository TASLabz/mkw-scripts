...
class VehiclePhysics:
    def __init__(self, playerIdx=0, addr=None):
        self.addr = addr if addr else VehiclePhysics.chain(playerIdx)
    ...
    def chain(playerIdx=0) -> int:
        return VehicleDynamics.vehicle_physics(playerIdx)
    
    @staticmethod
    def inertia_tensor(playerIdx=0) -> mat34:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def inverse_inertia_tensor(playerIdx=0) -> mat34:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def rotation_speed(playerIdx=0) -> float:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def external_velocity(playerIdx=0) -> vec3:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def external_velocity_accel(playerIdx=0) -> vec3:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def moving_road_velocity(playerIdx=0) -> vec3:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def moving_water_velocity(playerIdx=0) -> vec3:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def speed_norm(playerIdx=0) -> float:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def main_rotation(playerIdx=0) -> quatf:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def full_rotation(playerIdx=0) -> quatf:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def accel_norm(playerIdx=0) -> vec3:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def rotation_vector_norm(playerIdx=0) -> vec3:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def gravity(playerIdx=0) -> float:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
        gravity_ref = vehicle_physics_ref + 0x148
        return memory.read_f32(gravity_ref)
    
    def inst_gravity(playerIdx=0) -> float:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
        gravity_ref = vehicle_physics_ref + 0x148
        return memory.read_f32(gravity_ref)
    
    @staticmethod
    def internal_velocity(playerIdx=0) -> vec3:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def no_gravity(playerIdx=0) -> bool:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def in_bullet(playerIdx=0) -> bool:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def stabilization_factor(playerIdx=0) -> float:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
    ...
    @staticmethod
    def speed_fix(playerIdx=0) -> float:
        vehicle_physics_ref = VehiclePhysics.chain(playerIdx)
